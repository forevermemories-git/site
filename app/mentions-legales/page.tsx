      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-dark">Éditeur du site</h2>
            <div className="bg-gray-50 p-6 rounded-xl border border-gray-100">
              <p className="mb-2"><strong>Raison sociale :</strong> Agence ÜMAIN</p>
              <p className="mb-2"><strong>Forme juridique :</strong> Société par actions simplifiée (Société à associé unique)</p>
              <p className="mb-2"><strong>Capital social :</strong> 500,00 €</p>
              ...
              <p className="mb-2"><strong>Date d'immatriculation :</strong> 04/08/2025</p>
              ...
              <p className="mb-2"><strong>Directeur de la publication :</strong> Agence ÜMAIN</p>
            </div>
          </section>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-dark">Propriété intellectuelle</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-dark">Protection des données personnelles</h2>
            <p className="text-gray-700 mb-4">
            ...
            <p className="text-gray-700 mt-4">
              ...
              <a href="/politique-confidentialite" className="text-primary hover:underline font-medium">Politique de Confidentialité</a>.
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-dark">Cookies</h2>
            <p className="text-gray-700">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-dark">Liens hypertextes</h2>
            <p className="text-gray-700">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-dark">Limitation de responsabilité</h2>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-dark">Droit applicable et juridiction</h2>
            <p className="text-gray-700">
