        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none opacity-0 animate-fade-in-delay">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-cream">Éditeur du site</h2>
              <div className="bg-dark-card/50 backdrop-blur-sm p-6 rounded-xl border border-white/10">
                ...
                <p className="mb-2 text-cream/70"><strong className="text-cream">Forme juridique :</strong> Société par actions simplifiée (Société à associé unique)</p>
                <p className="mb-2 text-cream/70"><strong className="text-cream">Capital social :</strong> 500,00 €</p>
                ...
                <p className="mb-2 text-cream/70"><strong className="text-cream">Date d'immatriculation :</strong> 04/08/2025</p>
                <p className="mb-2 text-cream/70"><strong className="text-cream">Téléphone :</strong> <a href="tel:+33676815953" className="text-primary hover:text-primary-light transition-colors">06 76 81 59 53</a></p>
                ...
                <p className="text-cream/70"><strong className="text-cream">Directeur de la publication :</strong> Agence ÜMAIN</p>
              </div>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-cream">Hébergeur du site</h2>
              <div className="bg-dark-card/50 backdrop-blur-sm p-6 rounded-xl border border-white/10">
                <p className="mb-2 text-cream/70"><strong className="text-cream">Hébergeur :</strong> Vercel Inc.</p>
                <p className="mb-2 text-cream/70"><strong className="text-cream">Adresse :</strong> 440 N Barranca Ave #4133, Covina, CA 91723, États-Unis</p>
                <p className="text-cream/70"><strong className="text-cream">Site web :</strong> <a href="https://vercel.com" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-primary-light transition-colors">vercel.com</a></p>
              </div>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-cream">Propriété intellectuelle</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-cream">Protection des données personnelles</h2>
              <p className="text-cream/70 mb-4">
              ...
              <p className="text-cream/70 mt-4">
                ...
                <a href="/politique-confidentialite" className="text-primary hover:text-primary-light transition-colors font-medium">Politique de Confidentialité</a>.
              </p>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-cream">Cookies</h2>
              <p className="text-cream/70">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-cream">Liens hypertextes</h2>
              <p className="text-cream/70">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-cream">Limitation de responsabilité</h2>
              <p className="text-cream/70 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-cream">Droit applicable et juridiction</h2>
              <p className="text-cream/70">
