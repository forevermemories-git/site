          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="bg-white p-8 md:p-10 rounded-3xl border border-gray-200">
              ...
              <form className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full px-8 py-4 bg-primary text-white rounded-full font-semibold hover:bg-primary-dark transition-all flex items-center justify-center gap-2 shadow-lg shadow-primary/20 hover:shadow-xl hover:shadow-primary/30"
                >
                  Envoyer ma demande
                  <Send size={20} />
                </button>
