        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none opacity-0 animate-fade-in-delay">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-cream">Article 1 - Objet</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-cream">Article 2 - Services proposés</h2>
              ...
              <div className="bg-dark-card/50 backdrop-blur-sm p-6 rounded-xl border border-white/10">
                <ul className="space-y-2 text-cream/70">
                  <li><strong className="text-cream">• Location de la Starcam :</strong> Robot vidéo professionnel pour captation slow-motion et accélérée</li>
                  <li><strong className="text-cream">• Installation et configuration :</strong> Mise en place du matériel sur le lieu de l'événement</li>
                  <li><strong className="text-cream">• Accompagnement technique :</strong> Présence d'un opérateur pendant la durée de la prestation</li>
                  <li><strong className="text-cream">• Livraison instantanée :</strong> Les invités repartent immédiatement avec leurs vidéos</li>
                  <li><strong className="text-cream">• Accès en ligne :</strong> Mise à disposition d'un lien pour télécharger toutes les vidéos sous 48h</li>
                  <li><strong className="text-cream">• Qualité Full HD :</strong> Vidéos en haute définition avec rendu cinématographique</li>
                </ul>
              </div>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-cream">Article 3 - Réservation</h2>
              <p className="text-cream/70 mb-4">
                La réservation peut s'effectuer :
              </p>
              <ul className="list-disc list-inside text-cream/70 ml-4 space-y-1 mb-4">
                <li>Par téléphone au <a href="tel:+33676815953" className="text-primary hover:text-primary-light transition-colors">06 76 81 59 53</a></li>
                <li>Par email à <a href="mailto:hello@forevermemories.fr" className="text-primary hover:text-primary-light transition-colors">hello@forevermemories.fr</a></li>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-cream">Article 4 - Tarifs</h2>
              <p className="text-cream/70 mb-4">
              ...
              <p className="text-cream/70 mb-4">
                <strong className="text-cream">Frais supplémentaires :</strong> Des frais de déplacement peuvent s'appliquer en fonction de la distance
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-cream">Article 5 - Modalités de paiement</h2>
              <p className="text-cream/70 mb-4">
              ...
              <div className="bg-primary/10 backdrop-blur-sm p-6 rounded-xl border border-primary/20">
                <ul className="space-y-3 text-cream/70">
                  <li><strong className="text-cream">Acompte :</strong> 30% du montant total TTC à la réservation (non remboursable en cas d'annulation par le Client)</li>
                  <li><strong className="text-cream">Solde :</strong> 70% du montant total TTC à régler au plus tard le jour de la prestation, avant le début de l'événement</li>
                </ul>
              </div>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-cream">Article 6 - Annulation et modification</h2>

              <div className="mb-4">
                <h3 className="text-xl font-semibold mb-3 text-cream">6.1 - Annulation par le Client</h3>
                <p className="text-cream/70 mb-3">En cas d'annulation par le Client :</p>
                <ul className="list-disc list-inside text-cream/70 ml-4 space-y-1">
                  <li><strong className="text-cream">Plus de 30 jours avant :</strong> Remboursement de 70% de l'acompte</li>
                  <li><strong className="text-cream">Entre 30 et 15 jours avant :</strong> Remboursement de 50% de l'acompte</li>
                  <li><strong className="text-cream">Moins de 15 jours avant :</strong> Aucun remboursement</li>
                </ul>
              </div>

              <div className="mb-4">
                <h3 className="text-xl font-semibold mb-3 text-cream">6.2 - Report de date</h3>
                <p className="text-cream/70">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-3 text-cream">6.3 - Annulation par le Prestataire</h3>
                <p className="text-cream/70">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-cream">Article 7 - Obligations du Client</h2>
              <p className="text-cream/70 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-cream">Article 8 - Obligations du Prestataire</h2>
              <p className="text-cream/70 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-cream">Article 9 - Propriété intellectuelle et droit à l'image</h2>
              <div className="mb-4">
                <h3 className="text-xl font-semibold mb-3 text-cream">9.1 - Propriété des vidéos</h3>
                <p className="text-cream/70">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-3 text-cream">9.2 - Utilisation promotionnelle</h3>
                <p className="text-cream/70">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-cream">Article 10 - Responsabilité et assurance</h2>
              <p className="text-cream/70 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-cream">Article 11 - Protection des données personnelles</h2>
              <p className="text-cream/70">
                Les données personnelles collectées dans le cadre de la réservation et de la prestation sont traitées
                conformément à notre <a href="/politique-confidentialite" className="text-primary hover:text-primary-light transition-colors font-medium">Politique de Confidentialité</a>.
                Le Client dispose d'un droit d'accès, de rectification et de suppression de ses données en contactant
                <a href="mailto:hello@forevermemories.fr" className="text-primary hover:text-primary-light transition-colors"> hello@forevermemories.fr</a>.
              </p>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-cream">Article 12 - Droit de rétractation</h2>
              <p className="text-cream/70">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-cream">Article 13 - Réclamations</h2>
              <p className="text-cream/70 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-cream">Article 14 - Médiation</h2>
              <p className="text-cream/70 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-cream">Article 15 - Droit applicable et juridiction</h2>
              <p className="text-cream/70">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-cream">Article 16 - Acceptation des CGV</h2>
              <p className="text-cream/70">
            ...
            <div className="bg-primary/15 backdrop-blur-sm p-6 rounded-xl border border-primary/30 mt-12">
              <h3 className="text-xl font-semibold mb-3 text-cream">Contact</h3>
              <p className="text-cream/70 mb-2"><strong className="text-cream">Agence ÜMAIN - Forever Memories</strong></p>
              <p className="text-cream/70 mb-2">20 rue des Houis, 77580 Pierre-Levée</p>
              <p className="text-cream/70 mb-2">Téléphone : <a href="tel:+33676815953" className="text-primary hover:text-primary-light transition-colors">06 76 81 59 53</a></p>
              <p className="text-cream/70">Email : <a href="mailto:hello@forevermemories.fr" className="text-primary hover:text-primary-light transition-colors">hello@forevermemories.fr</a></p>
            </div>
