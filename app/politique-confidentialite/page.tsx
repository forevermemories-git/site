...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.forevermemories.fr/politique-confidentialite',
  },
}

function RightCard({ icon, title, description }: { icon: React.ReactNode; title: string; description: string }) {
  return (
    <div className="bg-white p-4 rounded-xl border border-[rgba(42,34,48,0.08)] hover:border-[rgba(182,94,171,0.25)] transition-colors">
      <div className="flex items-center gap-3 mb-2">
        <div className="text-[#B65EAB]">{icon}</div>
        <h4 className="font-semibold text-[#2A2230]">{title}</h4>
      </div>
      <p className="text-[#6C6172] text-sm">{description}</p>
    </div>
  )
}
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none opacity-0 animate-fade-in-delay">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-[#2A2230]">1. Responsable du traitement</h2>
              <div className="bg-white p-6 rounded-xl border border-[rgba(42,34,48,0.08)]">
                ...
                <p className="text-[#473F50]"><strong className="text-[#2A2230]">Téléphone :</strong> <a href="tel:+33676815953" className="!text-[#8E3F84] underline decoration-[#B65EAB]/40 underline-offset-2 hover:decoration-[#B65EAB] transition-colors">06 76 81 59 53</a></p>
              </div>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-[#2A2230]">2. Données collectées</h2>
              ...
              <div className="bg-white p-6 rounded-xl border border-[rgba(42,34,48,0.08)] mb-4">
                <h3 className="text-xl font-semibold mb-3 text-[#2A2230]">Données d'identification</h3>
              ...
              <div className="bg-white p-6 rounded-xl border border-[rgba(42,34,48,0.08)] mb-4">
                <h3 className="text-xl font-semibold mb-3 text-[#2A2230]">Données de réservation et événement</h3>
                <ul className="list-disc list-inside text-[#473F50] ml-4 space-y-1">
              ...
              <div className="bg-white p-6 rounded-xl border border-[rgba(42,34,48,0.08)] mb-4">
                <h3 className="text-xl font-semibold mb-3 text-[#2A2230]">Données de navigation</h3>
                <ul className="list-disc list-inside text-[#473F50] ml-4 space-y-1">
                  <li>Adresse IP</li>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-[#2A2230]">3. Finalités du traitement</h2>
              <p className="text-[#473F50] mb-4">
                Vos données personnelles sont collectées et traitées pour les finalités suivantes :
              </p>
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <span className="text-[#B65EAB] font-bold text-xl">•</span>
                  <div>
                    <strong className="text-[#2A2230]">Gestion des demandes de devis et réservations</strong>
                    <p className="text-[#473F50]">Pour traiter vos demandes de réservation de la Starcam et vous fournir nos services.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-[#B65EAB] font-bold text-xl">•</span>
                  <div>
                    <strong className="text-[#2A2230]">Communication</strong>
                    <p className="text-[#473F50]">Pour répondre à vos questions et vous informer sur nos services.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-[#B65EAB] font-bold text-xl">•</span>
                  <div>
                    <strong className="text-[#2A2230]">Amélioration de nos services</strong>
                    <p className="text-[#473F50]">Pour analyser l'utilisation de notre site et améliorer l'expérience utilisateur.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-[#B65EAB] font-bold text-xl">•</span>
                  <div>
                    <strong className="text-[#2A2230]">Marketing (avec consentement)</strong>
                    <p className="text-[#473F50]">Pour vous envoyer des offres promotionnelles si vous avez accepté de les recevoir.</p>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-[#2A2230]">4. Base légale du traitement</h2>
              <p className="text-[#473F50] mb-4">
              ...
              <ul className="list-disc list-inside text-[#473F50] ml-4 space-y-2">
                <li><strong className="text-[#2A2230]">L'exécution du contrat :</strong> pour la gestion de votre réservation</li>
                <li><strong className="text-[#2A2230]">Le consentement :</strong> pour l'envoi de communications marketing</li>
                <li><strong className="text-[#2A2230]">L'intérêt légitime :</strong> pour l'amélioration de nos services et la sécurité du site</li>
                <li><strong className="text-[#2A2230]">L'obligation légale :</strong> pour la conservation de données à des fins comptables et fiscales</li>
              </ul>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-[#2A2230]">5. Durée de conservation</h2>
              <p className="text-[#473F50] mb-4">
                Vos données personnelles sont conservées pendant les durées suivantes :
              </p>
              <div className="bg-white p-6 rounded-xl border border-[rgba(42,34,48,0.08)]">
                <ul className="space-y-2 text-[#473F50]">
                  <li><strong className="text-[#2A2230]">Données clients :</strong> 3 ans après la fin de la relation commerciale</li>
                  <li><strong className="text-[#2A2230]">Données de prospection :</strong> 3 ans à compter du dernier contact</li>
                  <li><strong className="text-[#2A2230]">Données comptables :</strong> 10 ans conformément aux obligations légales</li>
                  <li><strong className="text-[#2A2230]">Cookies et traceurs :</strong> 13 mois maximum</li>
                </ul>
              </div>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-[#2A2230]">6. Destinataires des données</h2>
              <p className="text-[#473F50] mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-[#2A2230]">7. Vos droits</h2>
              <p className="text-[#473F50] mb-4">
              ...
              <p className="text-[#473F50] mt-6">
                Pour exercer ces droits, vous pouvez nous contacter :
              </p>
              <ul className="list-disc list-inside text-[#473F50] ml-4 mt-2">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-[#2A2230]">8. Sécurité des données</h2>
              <p className="text-[#473F50] mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-[#2A2230]">9. Cookies</h2>
              <p className="text-[#473F50] mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-[#2A2230]">10. Réclamation auprès de la CNIL</h2>
              <p className="text-[#473F50]">
              ...
              <div className="bg-white p-4 rounded-xl border border-[rgba(42,34,48,0.08)] mt-4">
                <p className="text-[#473F50]">CNIL - 3 Place de Fontenoy - TSA 80715 - 75334 PARIS CEDEX 07</p>
                <p className="text-[#473F50]">Tél : 01 53 73 22 22</p>
                <p className="text-[#473F50]">Site web : <a href="https://www.cnil.fr" target="_blank" rel="noopener noreferrer" className="!text-[#8E3F84] underline decoration-[#B65EAB]/40 underline-offset-2 hover:decoration-[#B65EAB] transition-colors">www.cnil.fr</a></p>
              </div>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-[#2A2230]">11. Modifications</h2>
              <p className="text-[#473F50]">
